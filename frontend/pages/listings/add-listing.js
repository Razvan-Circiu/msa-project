...
export default function AddListing() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        if (newAnimal.name && newAnimal.species && newAnimal.gender && newAnimal.age && newAnimal.location && newAnimal.description && newAnimal.images.length > 0) {
            // For now, log the new animal to the console
            console.log('New Animal:', newAnimal);
            alert('Listing added successfully!');
            router.push('/listings/listings'); // Redirect to the listings page
        } else {
